...
{% include image.html url="{{ site.github.url }}/assets/img/unity_spacegame_with_some_lights.png" description="Scene with a basic room, some lights and a cube that can move." %}

![unity scene with some cubes and some lights]({{ site.github.url }}/assets/img/unity_spacegame_with_some_lights.png "Scene with a basic room, some lights and a cube that can move")
